...
export default function Home(){
    ...
    return(
        <section className=" cardo-regular-italic  pt-20
         max-sm:flex-col max-sm:items-center max-sm:justify-center max-sm:gap-0
          sm:flex sm:flex-row sm:items-center sm:justify-center gap-50 max-sm:px-10  max-sm:text-sm">
        <div className=" max-sm:w-full max-sm:mx-0 max-sm:px-0 px-20 mx-25 w-1/2">
         ...
         <div className="mt-5 max-sm:flex max-sm:flex-col gap-5 sm:flex sm:flex-raw  items-center justify-center  ">
          <button className="bg-gradient-to-r from-fuchsia-900 to-fuchsia-400 p-2 rounded text-gray-200 text-2xl w-1/2 cursor-pointer"><a href="https://www.linkedin.com/in/menna-elbadry21/">CV</a></button>
          <button className="bg-gradient-to-r from-fuchsia-900 to-fuchsia-400 p-2 rounded text-gray-200 text-2xl w-1/2 cursor-pointer"><a href="#project">Projects</a></button>
         </div>
         </div>
         <div className=" max-sm:w-full max-sm:mx-0 max-sm:px-0  w-1/2 move">
         <div className="w-50 h-50 border rounded-full flex items-center justify-center max-sm:mx-auto max-sm:mt-20 ">
